    ...
    datasets: [
      {
        label: "Logement",
        tension: 0.4,
        data: [0, 0, 0, 0, 0, 21, 0, 0, 0, 0, 0, 0, 46, 0, 0, 0, 0, 13, 24, 15, 24, 18, 64, 3, 144, 35, 9, 15, 8, 12, 19],
        borderWidth: 1,
      ...
      },
      {
        label: "Supermarché",
        tension: 0.4,
        data: [17, 25, 38, 52, 9, 11, 20, 3, 73, 61, 14, 42, 56, 13, 4, 7, 14, 9, 17, 10, 17, 12, 44, 1, 96, 23, 7, 12, 6, 9, 13],
        borderWidth: 1,
      ...
      },
      {
        label: "Restaurants",
        tension: 0.4,
        data: [34, 51, 81, 112, 20, 28, 50, 7, 146, 121, 26, 78, 104, 25, 8, 14, 26, 17, 33, 20, 33, 24, 88, 4, 192, 47, 12, 20, 10, 15, 25],
        borderWidth: 1,
      ...
      },
      {
        label: "Animaux",
        tension: 0.4,
        data: [20, 1, 35, 65, 3, 4, 7, 1, 85, 69, 12, 54, 70, 15, 2, 4, 8, 3, 6, 4, 8, 6, 22, 0, 80, 19, 3, 5, 2, 3, 6],
        borderWidth: 1,
      ...
      },
      {
        label: "Carburant",
        tension: 0.4,
        data: [42.99, 9, 73, 105, 33, 44, 77, 9, 115, 93, 24, 78, 105, 30, 11, 44, 88, 33, 66, 44, 88, 66, 110, 9, 160, 39, 33, 55, 11, 33, 66],
        borderWidth: 1,
      ...
      },
      {
        label: "Divers",
        tension: 0.4,
        data: [30, 7, 42, 80, 5, 6, 9, 7, 105, 83, 18, 63, 84, 18, 3, 6, 12, 5, 9, 6, 12, 9, 33, 2, 120, 29, 5, 8, 3, 5, 9],
        borderWidth: 1,
      ...
      },
      {
        ...
        tension: 0.4,
        data: [6, 39, 81, 57, 14, 33, 72, 48, 17, 95, 60, 25, 8, 43, 26, 77, 12, 51, 30, 69],
        borderWidth: 1,
...
new Chart(ctxentre, {
  ...
  data: {
    ...
    datasets: [
      {
        data: [1100, 1400, 1367, 900, 1284, 1000, 685, 978, 1150, 1328, 1500, 1378],
        borderWidth: 1,
      },
    ],
  },
